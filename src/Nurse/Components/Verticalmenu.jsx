      ...
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        <li className="nav-item">
          ...
          {activeMenu === 'patients' && (
            <ul className="nav flex-column ms-3">
              ...
              <li className="nav-item">
                <Link to="/Find Patient" className="nav-link">
                  <img src={Plus} alt="" className="nav-img-plus" />
        ...
        <li className="nav-item">
          ...
          {activeMenu === 'Account' && (
            <ul className="nav flex-column ms-3">
              <li className="nav-item">
                <Link to="/Process Payment" className="nav-link">
                  <img src={Plus} alt="" className="nav-img-plus" />
        ...
        <li className="nav-item">
          ...
          {activeMenu === 'Pharmacy' && (
            <ul className="nav flex-column ms-3">
              <li className="nav-item">
                <Link to="/Give Drugs" className="nav-link">
                  <img src={Plus} alt="" className="nav-img-plus" />
                  <div className="topic">Give Drugs</div>
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/Add Drugs" className="nav-link">
                  <img src={Plus} alt="" className="nav-img-plus" />
                  <div className="topic">Add Drugs</div>
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/Manage Drugs" className="nav-link">
                  <img src={Plus} alt="" className="nav-img-plus" />
        ...
        <li className="nav-item">
          ...
          {activeMenu === 'Report' && (
            <ul className="nav flex-column ms-3">
              <li className="nav-item">
                <Link to="/Today Sales Report" className="nav-link">
                  <img src={Plus} alt="" className="nav-img-plus" />
